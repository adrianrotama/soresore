...
export const TILE_MODEL_Y_OFFSET = {
  ...
  // Thin slab (0.04 m); foot-snap puts bottom at cell base — lift to ~0.90 (grass tops at 1.0).
  water: 0.6,
};
...
export const TILE_PALETTES = {
  ...
  asphaltLight: { top: "#a7a299", side: "#8a8175" },
  stair: { top: "#c4a882", side: SIDE_TAN },
  brick: { top: "#d9a98a", side: "#b07a5a" },
  water: { top: "#5a9aaa", side: "#4a7a6a" },
};
...
export const TILE_INFO = {
  ...
  asphaltLight: { walkable: true },
  stair: { walkable: true },
  brick: { walkable: true },
  water: { walkable: false },
};

export function isTileTypeWalkable(tileType) {
  return TILE_INFO[tileType]?.walkable !== false;
}
