 ...
 *   Y   — up; player feet at PLAYER_SPAWN_Y
 *
...
export const STATION_START = [-40, 0, -7];
...
export function getPlayerSpawn(start = STATION_START) {
  ...
  return { x: hx + 6, y: PLAYER_SPAWN_Y, z: hz + 8 };
}
...
export function platformLayout(start = STATION_START) {
  ...
  return {
    position: [start[0] + trackSpan / 2, 0.02, start[2] + 1.5],
