...
/** Cozy skin tones (MVP — 3 options). */
export const SKIN_COLORS = {
  fair: { label: "Fair", color: "#FFE3D1" },
  medium: { label: "Medium", color: "#FFD2B8" },
  tan: { label: "Tan", color: "#E5AA85" },
  deep: { label: "Deep", color: "#C98D65" },
};

export const SKIN_COLOR_KEYS = Object.keys(SKIN_COLORS);
...
export function resolveSkinColor(skinColorKey) {
  return (
    SKIN_COLORS[skinColorKey]?.color ??
    SKIN_COLORS[DEFAULT_APPEARANCE.skinColor].color
  );
}
