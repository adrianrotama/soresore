...
export const ENV_REGISTRY = {
  ...
  bench: {
    ...
    collision: { blocks: true, cellsX: 1, cellsZ: 0.7, offset: [0.1, 0, 0] },
  },
  trashcan: {
    url: "/images/environments/trashcan.gltf",
    collision: { blocks: true, cellsX: 0.5, cellsZ: 0.5 },
  },
  tree: {
  ...
  streetLantern: {
    ...
    collision: { blocks: true, cellsX: 0.6, cellsZ: 0.6, },
  },
  ...
  japaneseStore: { url: "/images/environments/japaneseStore.glb" },
  bridge: { url: "/images/environments/bridge-log-2.glb" },
};
