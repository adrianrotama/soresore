...
/**
 * Bridge deck tune — foot-snap anchors mesh bottom; offset Y is code-only (Blender
 * uniform Z/Y moves cancel out). ~0.8 m looked right in playtest.
 * Cat walk height on BW tiles: BRIDGE_WALK_SURFACE_LIFT in testTileMap.js.
 */
