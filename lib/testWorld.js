import { buildCollisionVolumes } from "./decorationCollision";
...
const riverSlopeOrigin = { x: 7, z: 13 };
const riverSlopeDecorations = [
  { kind: "treeLarge", gx: riverSlopeOrigin.x + 0, gz: riverSlopeOrigin.z + 0 },
  { kind: "treeLarge", gx: riverSlopeOrigin.x + 0, gz: riverSlopeOrigin.z + 4 },
  { kind: "treeLarge", gx: riverSlopeOrigin.x + 0, gz: riverSlopeOrigin.z + 8 },
  { kind: "flowerA", gx: riverSlopeOrigin.x + 4, gz: riverSlopeOrigin.z + 3 },
  { kind: "flowerB", gx: riverSlopeOrigin.x + 5, gz: riverSlopeOrigin.z + 2},
  { kind: "flowerB", gx: riverSlopeOrigin.x + 4, gz: riverSlopeOrigin.z + 8 },
  
]

const BRIDGE_DECK_OFFSET_Y = 0.8;
const riverBridgeDecoration = {
  kind: "bridge",
  gx: 17.5,
  gz: 21.5,
  offset: [0, -BRIDGE_DECK_OFFSET_Y, 0],
};

const riverBankOrigin = { x: 11, z: 14 };
...
export const TEST_WORLD = {
  ...
  decorations: [
    ...
    ...railRoadDecorations,
    ...riverSlopeDecorations,
    riverBridgeDecoration,
...
/** Precomputed oriented boxes blocked by decorations/landmarks (built once at load). */
TEST_WORLD.collisionVolumes = buildCollisionVolumes(TEST_WORLD);
